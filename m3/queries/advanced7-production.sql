...
-- Production DB: breakdown for a user known to have authored posts
WITH post_karma AS (
  ...
  WHERE p.user_id = 'e100ef11-94ce-4f9e-a23f-a4fbc2d38783'
...
comment_karma AS (
  ...
  WHERE c.user_id = 'e100ef11-94ce-4f9e-a23f-a4fbc2d38783'
  GROUP BY p.subreddit_id
),
combined AS (
